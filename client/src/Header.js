...
<header className="flex justify-between font-mono">
    <Link to={"/"} className="flex justify-center items-centre gap-3 "> 
    ...
    <div className=" flex justify-end gap-4">
        ...
        <Link to={user?'/account':"/login"} className='flex border border-sky-300 rounded-full p-3 items-center  border-3 shadow shadow-sky-400 '>
